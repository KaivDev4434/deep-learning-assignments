# -*- coding: utf-8 -*-
"""DS677 Week6HW1 sample code.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17if3flDURpGRt7bbNly0x7giZG_nbDbn
...
def load_data_iterator(
    task, split, epoch=1, max_tokens=4000, num_workers=1, cached=True
):
...
class NoamOpt:
    ...
    def rate(self, step=None):
        ...
        return (
            0
            if not step
            else self.factor * get_rate(self.model_size, step, self.warmup)
        )
...
checkdir = "./checkpoints/rnn"
# Build the command as a list of strings
command = [
    "python",
    "/course/2024/fall/ds/677/gwang/kd454/Week_6/checkpoints/rnn/average_checkpoints.py",
    "--inputs",
    checkdir,
...
itr = load_data_iterator(
    task, "test", 1, config.max_tokens, config.num_workers
).next_epoch_itr(shuffle=False)
...
pred = pd.DataFrame({"id": range(len(hyps)), "sentence": hyps})
